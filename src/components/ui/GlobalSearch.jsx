...
const TOOLS = [
  ...
  { title: 'Scenario Builder',          desc: 'Map decision points and consequences. Build manually or draft with AI.',                      path: '/scenario-branching',     icon: GitFork,    keywords: 'branching diagram tree decision consequence outcome flowchart map storyline storyboard AI draft generate BYOK scenario builder visual' },
